...
const UploadInsuredPage = () => {
  ...
  const { retailDataLoading } = useRetail();
  ...
  return (
    <>
      <div>
        Procesados {retailDataLoading.data.size} de {retailDataLoading.total}
      </div>
      <div>{retailDataLoading.success.size} correctos</div>
      <div>{retailDataLoading.error.size} con error</div>
    </>
  );
};

export default UploadInsuredPage;
