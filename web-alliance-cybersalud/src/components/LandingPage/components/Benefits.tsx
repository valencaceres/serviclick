...
export default function Benefits({cards}: Props){
    return (
        <WrapperSm className="mb-16 md:mb-32">
            <h2 className="font-bold text-3xl md:text-5xl text-center mb-8 md:mb-16">¡Elige tu beneficio!</h2>
            <div className='px-10 relative'>
                <button className='swiper-button-prev lg:hidden absolute w-8 h-8 rounded-full left-0 top-24 bg-very-gray z-10'>
                ...
                <button className='swiper-button-next lg:hidden absolute w-8 h-8 rounded-full right-0 top-24 bg-very-gray z-10'>
