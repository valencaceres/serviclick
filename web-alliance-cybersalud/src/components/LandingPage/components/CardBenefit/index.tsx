...
export default function CardBenefit({id, productplan_id, hiring_conditions, name, price, detail, assistances}: Props){
    return(
        <div>
            ...
            <div className="text-center pt-4 pb-5">
                ...
                <p className="font-medium">*Consulta por plan familiar</p>
            </div>
