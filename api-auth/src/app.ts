...
const routeMappings = [
  { path: "/api-auth/rol", router: routes.rolRouter },
  { path: "/api-auth/action", router: routes.actionRouter },
  { path: "/api-auth/application", router: routes.applicationRouter },
  { path: "/api-auth/district", router: routes.districtRouter },
  { path: "/api-auth/person", router: routes.personRouter },
  { path: "/api-auth/user", router: routes.userRouter },
];
