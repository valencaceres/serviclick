  ...
  return (
    <footer className="flex flex-col" id="contact ">
      <div className=" flex flex-col bg-slate-50  ">
        <h2 className="  px-16 py-2 text-center font-bold">
          Los descuentos y beneficios de salud son entregados en línea a través
          de i-Med o a través de red de prestadores propios
        </h2>
        <div className="flex flex-wrap items-center justify-between gap-4 px-16 py-4">
        ...
        <div className="flex w-full cursor-pointer flex-wrap items-center justify-center gap-4 bg-[#222222] py-4 md:justify-between">
          <div className="flex flex-wrap gap-4 px-12 text-sm text-[#B2B2B2]">
            <div className="flex flex-col gap-1">
              ...
              <Link
                target="_blank"
                href="https://www.serviclick.cl/aboutus"
                passHref
              >
              ...
              <Link
                target="_blank"
                href="https://www.serviclick.cl/companies"
                passHref
              >
              ...
              <Link
                target="_blank"
                href="https://www.serviclick.cl/people"
                passHref
              >
            ...
            <div className="grid md:grid-cols-2 md:gap-x-4 md:gap-y-1">
              {categories.map((assistance: any) => (
                <Link
                  href={`https://www.serviclick.cl/family/${assistance.family_id}`}
                  passHref
                  key={assistance.id}
                  target="_blank"
                >
