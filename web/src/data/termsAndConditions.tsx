export const termsAndCondicions = {
  data: (
    <div>
      ...
      <div>&nbsp;</div>
      <div>
        2.- Las funciones que ofrece SERVICLICK, el acceso y uso de los canales
        de atención por parte de las personas que lo requieran y las normas
        relativas al almacenamiento, tratamiento, uso y disposición de los datos
        personales de éstas, se regulan por los siguientes Términos y
        Condiciones, así como por la legislación vigente, especialmente por la
        Ley Nº 19.496 sobre Protección de los Derechos de los Consumidores y por
        la Ley Nº 19.628 sobre Protección de la Vida Privada. Las personas que
        acepten los Términos y Condiciones se denominarán, para los efectos de
        este documento, como “Usuarios”.
      </div>
      <div>&nbsp;</div>
      <div>
        <b>PRIMERO:</b> CANALES DE ATENCIÓN
      </div>
      <div>&nbsp;</div>
      <div>
        1.- Actualmente los Canales de Atención están constituidos por: El sitio
        web www..cl; El botón de pago de SERVICLCIK ubicado en sitios web
        distintos de www.XXXXXXXXX /iv/ App XXXXX para iOS y Android,
        ...
        mediante actos positivos, tu voluntad de adquirir uno o más bienes o
        servicios, en la forma indicada en este texto precedente.
      </div>
      <div>&nbsp;</div>
      <div>
      ...
      <div>
        ...
        aceptación sin reservas de los presentes Términos y Condiciones. El uso
        indebido de los Canales de Atención, el incumplimiento de lo establecido
        en el presente instrumento o cualquier acción u omisión que implique
        algún tipo de fraude en contra de La Compañía, facultará a esta última
        para bloquear al participante del uso de los Canales de Atención, sin
        perjuicio del ejercicio de las acciones legales que pudieren
        corresponder.
      </div>
      <div>&nbsp;</div>
      <div>
        ...
        correo electrónico xxxxxxxxxx , o contactarce el fono al fono +56
        xxxxxxxxx, así como reemplazarla por una nueva mediante el procedimiento
      ...
      <div>&nbsp;</div>
      <div>
        <b>CUARTO:</b> PAGO DE CUENTAS.
      </div>
      <div>&nbsp;</div>
      <div>
        1.- Para realizar el pago de cuentas de empresas previamente inscritas,
        el Usuario debe ser capaz de acuerdo a la legislación chilena.
      </div>
      <div>&nbsp;</div>
      <div>
      ...
      <div>
        ...
        cliente en los Bancos o Instituciones Financieras afiliadas a
        SERVICLCIK.
      </div>
      <div>&nbsp;</div>
      <div>
      ...
      <div>
        ...
        dirigir una comunicación a XXXXXXXXXXX
      </div>
      <div>&nbsp;</div>
      <div>
      ...
      <div>
        ...
        de Atención al Cliente teléfono número XXXXXXXXXXXX; o (ii) a la
        siguiente casilla de correo electrónico XXXXXXXXX Solución de
        conflictos. Cualquier dificultad o controversia que se suscite en
        relación con estos Términos y Condiciones podrá ser sometida a
        conocimiento del Juzgado De Policía Local competente de acuerdo con la
        ...
        correspondientes en otras materias. Domicilio y legislación aplicable.
        Los presentes Términos y Condiciones se rigen por la legislación
        chilena. La Compañía fija su domicilio en la ciudad y ciudad de
        Santiago.
      </div>
    </div>
  ),
