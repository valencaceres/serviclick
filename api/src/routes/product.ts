...
ProductRouter.post("/assignPrices", auth, isAuthenticated, isAdmin, assignPrices);
ProductRouter.put("/update/:id", auth, isAuthenticated, isAdmin, updateProduct);
ProductRouter.delete("/delete/:id", auth, isAuthenticated, isAdmin, deleteProduct);
ProductRouter.get("/list/:agent_id", auth, listProducts);
ProductRouter.get("/getByFamilyId/:agent_id/:family_id", auth, getProductByFamilyId);
...
ProductRouter.get("/getByProductPlanId/:productplan_id", auth, getByProductPlanId);
