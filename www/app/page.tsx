      ...
      <section className="relative bg-background h-[480px] sm:h-[600px] lg:h-[600px] duration-75">
        <div className="bg-primary flex flex-col lg:flex-row-reverse items-center py-4 h-96 lg:justify-evenly">
          <div className="flex flex-col py-4 gap-4 items-center justify-center lg:order-2">
            <h2 className="uppercase text-4xl text-center text-background font-bold flex justify-center lg:justify-start w-full">
              ¿Por qué Serviclick?
            </h2>
            <ul className="flex lg:flex-col px-6 justify-around gap-4 lg:gap-2 text-lg lg:justify-start flex-wrap w-full list-disc uppercase font-semibold text-background marker:text-foreground">
              <li>Confiable</li>
              <li>Rápido</li>
              <li>Oportuno</li>
            </ul>
          </div>
          <div className="flex justify-center items-center order-1 lg:order-2 relative lg:-bottom-24">
            <Image
