    ...
    <section className="container py-8 max-w-5xl flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-2">
        ...
        <p>
          ...
          oficina 702, en adelante SERVICLICK, ofrece diversas funciones y
          alternativas de asistencias para personas, empresas, fundaciones,
          sindicatos, banca, retail, , mediante los canales de atención,
          definidos más adelante, que pone a disposición del público.
        </p>
        <p>
      ...
      <div className="flex flex-col gap-2">
        ...
        <p>
          ...
          sitio web www.serviclcick.cl; El botón de pago de SERVICLICK ubicado
          en sitios web distintos de www.ssrviclcick.cl para iOS y Android,
      ...
      <div className="flex flex-col gap-2">
        ...
        <p>
          ...
          los Canales de Atención y/o a los servicios relacionados.
        </p>
      </div>
      <div className="flex flex-col gap-2">
        <h2 className="uppercase">
