...
CREATE OR REPLACE FUNCTION app.case_get_services_and_values(
    p_insured_id uuid, 
...
---p_assistance_is is not null se elimina ya que siempre se requerira el campo assistances por que ahora ese campo se puede modificar entonces necesito traerme los demas assistances siempre